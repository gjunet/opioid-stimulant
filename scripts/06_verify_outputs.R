...
expected_figures <- c("Figure1_adjusted_odds_ratios.png","Figure1_adjusted_odds_ratios.svg","Figure1_adjusted_logit_coefficients.png","Figure1_adjusted_logit_coefficients.svg","Figure1_adjusted_odds_ratios_opioid_reference.png","Figure1_adjusted_odds_ratios_opioid_reference.svg","Figure1_adjusted_logit_coefficients_opioid_reference.png","Figure1_adjusted_logit_coefficients_opioid_reference.svg")
