...
expected_figures <- c("Figure1_adjusted_odds_ratios.png","Figure1_adjusted_odds_ratios.svg","Figure1_adjusted_odds_ratios_opioid_reference.png","Figure1_adjusted_odds_ratios_opioid_reference.svg")
