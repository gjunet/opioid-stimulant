...
# The order matters: scripts 02-08 require the derived file created by script 01,
...
scripts <- c("01_build_analysis_data.R", "02_primary_tables.R",
             ...
             "07_sensitivity_alcohol_adjustment.R",
             "08_figure1_forest_plots.R", "06_verify_outputs.R")
...
message("\nReplication complete. Tables: ", table_dir, "; figures: ", figure_dir)
